...
namespace Watson\Active\Facades { 
    ...
    class Active {
         ...
         * @static 
         */ 
        public static function active($routes, $class = null)
        {
         ...
         * @static 
         */ 
        public static function isFullPath($routes)
        {
            return \Watson\Active\Active::isFullPath($routes);
        }
         ...
         * @static 
         */ 
        public static function path($routes, $class = null)
        {
         ...
         * @static 
         */ 
        public static function route($routes, $class = null)
        {
...
namespace App\Facades { 
    ...
    class AdminLog {
        ...
        {
            return \App\Services\AdminLogService::log($action);
        }
        ...
        {
            return \App\Services\AdminLogService::userIpAddress();
        }
        ...
        public static function userAgent()
        {
            return \App\Services\AdminLogService::userAgent();
        }
...
namespace  { 
    ...
    class AdminLog extends \App\Facades\AdminLog {}
