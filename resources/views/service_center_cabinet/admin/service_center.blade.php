    ...
    <div ng-controller="RefactorScController" ng-cloak>
        ...
        <section class="content" >
            <div class="row">
                ...
                {{--============================Уровень заполнености /==================================--}}
                <div class="col-md-12">
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-line-chart" aria-hidden="true"></i>  Уровень заполнености</h3>
                        </div>
                        <div class="box-body">
                            <div class="progress">
                                <div class="progress-bar progress-bar-green" ng-if="progressBarAdminShow" role="progressbar" ng-style="{width: progressBarAdmin()}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <table class="table">
                                        <tr ng-if="sc.price.length == 0">
                                            <td>Виды и стоимость работ</td>
                                        </tr>
                                        <tr ng-if="sc.service_phones.length == 0">
                                            <td>Телефоны</td>
                                        </tr>
                                        <tr ng-if="sc.service_emails.length == 0">
                                            <td>Почта</td>
                                        </tr>
                                        <tr ng-if="sc.manufacturers.length == 0">
                                            <td>Бренды</td>
                                        </tr>
                                        <tr ng-if="sc.advantages.length == 0">
                                            <td>Преимущества</td>
                                        </tr>

                                        <tr ng-if="sc.tags.length == 0">
                                            <td>Теги</td>
                                        </tr>
                                        <tr ng-if="!sc.about">
                                            <td>О компании</td>
                                        </tr>
                                        <tr ng-if="sc.service_photo.length == 0">
                                            <td>Фотографии, cертификаты и лицензии</td>
                                        </tr>
                                        <tr ng-if="sc.personal.length == 0">
                                            <td>Команда сервиса</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
